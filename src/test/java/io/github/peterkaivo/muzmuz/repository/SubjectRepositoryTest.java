...
public class SubjectRepositoryTest {
    ...
    public void testRead() {
        DSubject dSubject = subjectRepository.findById(22L).orElse(null);
    ...
    public void testReadAll() {
        List<DSubject> allSubjects = (List<DSubject>) subjectRepository.findAll();
    ...
    public void testCRUDCompany() {
        ...
        DCompany dCompany2 = subjectRepository.save(dCompany1);

        DSubject dSubject1 = subjectRepository.findById(dCompany2.getId()).orElse(null);
        ...
        subjectRepository.save(dCompany3);

        DSubject dSubject2 = subjectRepository.findById(dCompany2.getId()).orElse(null);
        ...
        subjectRepository.deleteById(dCompany4.getId());

        DSubject dSubject3 = subjectRepository.findById(dCompany2.getId()).orElse(null);
    ...
    public void testCRUDPerson() {
        ...
        DPerson dPerson2 = subjectRepository.save(dPerson1);

        DSubject dSubject1 = subjectRepository.findById(dPerson2.getId()).orElse(null);
        assertNotNull(dSubject1);
        ...
        subjectRepository.save(dPerson3);

        DSubject dSubject2 = subjectRepository.findById(dPerson2.getId()).orElse(null);
        assertNotNull(dSubject2);
        ...
        subjectRepository.deleteById(dPerson4.getId());

        DSubject dSubject3 = subjectRepository.findById(dPerson2.getId()).orElse(null);
        assertNull(dSubject3);
    }
}
