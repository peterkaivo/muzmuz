...
@SpringBootTest
public class GraphicsRepositoryTest {
    ...
    public void testRead() {
        DGraphics dGraphics = graphicsRepository.findById(22L).orElse(null);
    ...
    public void testReadAll() {
        List<DGraphics> allGraphics = (List<DGraphics>) graphicsRepository.findAll();
    ...
    public void testCRUDPhoto() {
        ...
        DPhoto dPhoto2 = graphicsRepository.save(dPhoto1);

        DGraphics dGraphics1 = graphicsRepository.findById(dPhoto2.getId()).orElse(null);
        ...
        graphicsRepository.save(dPhoto3);

        DGraphics dGraphics2 = graphicsRepository.findById(dPhoto2.getId()).orElse(null);
        ...
        graphicsRepository.deleteById(dPhoto4.getId());

        DGraphics dGraphics3 = graphicsRepository.findById(dPhoto2.getId()).orElse(null);
    ...
    public void testCRUDImage() {
        ...
        DImage dImage2 = graphicsRepository.save(dImage1);

        DGraphics dGraphics1 = graphicsRepository.findById(dImage2.getId()).orElse(null);
        assertNotNull(dGraphics1);
        ...
        graphicsRepository.save(dImage3);

        DGraphics dGraphics2 = graphicsRepository.findById(dImage2.getId()).orElse(null);
        assertNotNull(dGraphics2);
        ...
        graphicsRepository.deleteById(dImage4.getId());

        DGraphics dGraphics3 = graphicsRepository.findById(dImage2.getId()).orElse(null);
        assertNull(dGraphics3);
    }
    ...
    public void testCRUDDrawing() {
        ...
        DDrawing dDrawing2 = graphicsRepository.save(dDrawing1);

        DGraphics dGraphics1 = graphicsRepository.findById(dDrawing2.getId()).orElse(null);
        assertNotNull(dGraphics1);
        ...
        graphicsRepository.save(dDrawing3);

        DGraphics dGraphics2 = graphicsRepository.findById(dDrawing2.getId()).orElse(null);
        assertNotNull(dGraphics2);
        ...
        graphicsRepository.deleteById(dDrawing4.getId());

        DGraphics dGraphics3 = graphicsRepository.findById(dDrawing2.getId()).orElse(null);
        assertNull(dGraphics3);
    }
}
