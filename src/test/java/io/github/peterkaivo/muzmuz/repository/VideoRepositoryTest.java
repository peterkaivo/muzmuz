...
public class VideoRepositoryTest {
    ...
    public void testRead() {
        DVideo dVideo = videoRepository.findById(2L).orElse(null);
    ...
    public void testReadAll() {
        List<DVideo> allVideos = (List<DVideo>) videoRepository.findAll();
    ...
    public void testCRUD() {
        ...
        DVideo dVideo2 = videoRepository.save(dVideo1);

        DVideo dVideo3 = videoRepository.findById(dVideo2.getId()).orElse(null);
        ...
        videoRepository.save(dVideo3);

        DVideo dVideo4 = videoRepository.findById(dVideo2.getId()).orElse(null);
        assertNotNull(dVideo4);
        assertEquals("panjo_promo.avi", dVideo4.getFileName());
        assertEquals("2. 4. 2023", dVideo4.getAcquired());

        videoRepository.deleteById(dVideo4.getId());

        DVideo dVideo5 = videoRepository.findById(dVideo2.getId()).orElse(null);
        assertNull(dVideo5);
    }
}
