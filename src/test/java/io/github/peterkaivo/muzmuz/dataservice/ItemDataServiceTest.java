...
public class ItemDataServiceTest {
    ...
    public void testRead() {
        DItem dItem = itemDataService.findById(2001L).orElse(null);
        assertNotNull(dItem);
    ...
    public void testReadAll() {
        List<DItem> allItems = (List<DItem>) itemDataService.findAll();
    ...
    public void testCRUD() {
        ...
        DItem dItem2 = itemDataService.save(dItem1);

        DItem dItem3 = itemDataService.findById(dItem2.getId()).orElse(null);
        ...
        itemDataService.save(dItem3);

        DItem dItem4 = itemDataService.findById(dItem2.getId()).orElse(null);
        ...
        itemDataService.deleteById(dItem4.getId());

        DItem dItem5 = itemDataService.findById(dItem2.getId()).orElse(null);
        assertNull(dItem5);
    }
}
