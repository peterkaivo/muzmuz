...
public class LinkDataServiceTest {
    ...
    public void testRead() {
        DLink dLink = linkDataService.findById(2L).orElse(null);
        assertNotNull(dLink);
    ...
    public void testReadAll() {
        List<DLink> allLinks = (List<DLink>) linkDataService.findAll();
    ...
    public void testCRUD() {
        ...
        DLink dLink2 = linkDataService.save(dLink1);

        DLink dLink3 = linkDataService.findById(dLink2.getId()).orElse(null);
        ...
        linkDataService.save(dLink3);

        DLink dLink4 = linkDataService.findById(dLink2.getId()).orElse(null);
        ...
        linkDataService.deleteById(dLink4.getId());

        DLink dLink5 = linkDataService.findById(dLink2.getId()).orElse(null);
        assertNull(dLink5);
    }
}
