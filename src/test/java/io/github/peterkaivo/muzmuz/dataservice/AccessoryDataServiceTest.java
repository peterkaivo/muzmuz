...
@SpringBootTest
public class AccessoryDataServiceTest {
    ...
    public void testRead() {
        DAccessory dAccessory = accessoryDataService.findById(2L).orElse(null);
    ...
    public void testReadAll() {
        List<DAccessory> allAccessories = (List<DAccessory>) accessoryDataService.findAll();
    ...
    public void testCRUD() {
        ...
        DAccessory dAccessory2 = accessoryDataService.save(dAccessory1);

        DAccessory dAccessory3 = accessoryDataService.findById(dAccessory2.getId()).orElse(null);
        ...
        accessoryDataService.save(dAccessory3);

        DAccessory dAccessory4 = accessoryDataService.findById(dAccessory2.getId()).orElse(null);
        ...
        accessoryDataService.deleteById(dAccessory4.getId());

        DAccessory dAccessory5 = accessoryDataService.findById(dAccessory2.getId()).orElse(null);
